            ...
            <div class="p-4 md:p-5">
                <div class="max-h-auto mx-auto max-w-md flex-col justify-center">
                    ...
                    <div class="flex justify-center my-6 gap-2">
                        <form action="" method="post" id="generatePDF">
                            @csrf
                            <button type="submit" class="bg-red-600 p-3 rounded flex gap-1" title="Generer le PDF">
...
<script>
    function generate(attestation) {
        ...
        var content = attestation.pdf_link
        console.log(content)
        document.querySelector('#generatePDF').setAttribute('action',content)
    }
</script>
